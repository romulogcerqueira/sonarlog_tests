...
const std::string PREFIX = std::string("pipeline");
...
int main(int argc, char const *argv[])
{
    ...
    // // real images
    // cv::Mat cart_real  = readImageFromFile(DATA_PATH_STRING + "/logs/paper/" + PREFIX + "/" + PREFIX + "_cart_real.yml");
    // cv::Mat polar_real = readImageFromFile(DATA_PATH_STRING + "/logs/paper/" + PREFIX + "/" + PREFIX + "_polar_real.yml");

    // simulated images
    cv::Mat cart_sim = readImageFromFile(DATA_PATH_STRING + "/logs/paper/" + PREFIX + "/" + PREFIX + "_cart_sim.yml");
    cv::Mat polar_sim = readImageFromFile(DATA_PATH_STRING + "/logs/paper/" + PREFIX + "/" + PREFIX + "_polar_sim.yml");

    // mask
    cv::Mat cart_mask = readImageFromFile(DATA_PATH_STRING + "/logs/paper/ssiv/ssiv_cart_mask.yml");
    ...
    // cv::imwrite(SAVE_PATH_STRING + PREFIX + "_cart_real.png", cart_real_color, compression_params);
    cv::imwrite(SAVE_PATH_STRING + PREFIX + "_cart_sim.png", cart_sim_color, compression_params);
    // cv::imwrite(SAVE_PATH_STRING + PREFIX + "_polar_real.png", polar_real_color, compression_params);
    cv::imwrite(SAVE_PATH_STRING + PREFIX + "_polar_sim.png", polar_sim_color, compression_params);
